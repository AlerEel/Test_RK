...
- `parser.py` - получение реальных заголовков с сайта Госуслуг
- `parser_v3.py` - парсер для получения данных с API Госуслуг (использует заголовки из parser.py)
...
**Примечание:** Первый запуск может занять несколько минут. Процесс включает:
1. Получение реальных заголовков с сайта Госуслуг
2. Парсинг данных с API
3. Загрузку данных в базу данных
